...
expected1 <- package_readRDS(paste0(test_config$LINCS_expected_dge_dir, "ADORA3_140_24h-expected.Rds"))
expected2 <- package_readRDS(paste0(test_config$LINCS_expected_dge_dir, "AFTPH_54812_24h-expected.Rds"))

...
sut <- LMMDrugRepurpose$new(lmmDGE = LMMDGELmer$new(), drugSignatureLoader = drugSignatureLoaderByDrugName)
...
expected <- absolute_path_readRDS("unit_test_data/drug_repurpose/LMMDrugRepurpose_expected.Rds")
...
test_that("test-LMMDrugRepurposeByLmer", {

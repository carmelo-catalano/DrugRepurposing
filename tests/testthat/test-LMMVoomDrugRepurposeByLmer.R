...
lmmVoomLmerDGE <- LMMVoomLmerDGE$new()
sut <- LMMVoomDrugRepurpose$new(lmmVoomDGE = lmmVoomLmerDGE, drugSignatureLoader = drugSignatureLoaderByDrugName)
...
test_that("test-LMMVoomDrugRepurposeByLmer", {

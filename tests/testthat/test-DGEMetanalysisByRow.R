...
# given
drug_by_gene_dge_6h <- absolute_path_readRDS("unit_test_data/LMMDGE/metanalysis/drug_dge_6h.Rds")
drug_by_gene_dge_24h <- absolute_path_readRDS("unit_test_data/LMMDGE/metanalysis/drug_dge_24h.Rds")
...
expected <- absolute_path_readRDS("unit_test_data/LMMDGE/metanalysis/DGEMetanalysis_expected.Rds")

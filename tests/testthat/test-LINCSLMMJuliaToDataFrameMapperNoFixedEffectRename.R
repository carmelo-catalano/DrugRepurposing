...
sut <- LINCSLMMJuliaToDataFrameMapper$new()
...
expected <- absolute_path_readRDS("unit_test_data/LMMDGE/LINCSLMMJuliaToDataFrameMapperNoFixedEffectRename.Rds")

# when
result <- sut$map(LMM_output, NA, "pert_iname", NA, "pert_iname")

# then
test_that("test-LINCSLMMJuliaToDataFrameMapperNoFixedEffectRename", {

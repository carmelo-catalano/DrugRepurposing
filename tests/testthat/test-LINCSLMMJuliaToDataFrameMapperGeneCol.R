...
expected <- absolute_path_readRDS("unit_test_data/LMMDGE/LINCSLMMJuliaToDataFrameMapperGeneColExpected.Rds")

# when
result <- sut$map(LMM_output, gene_id, "pert_iname", "drug", "pert_iname")

# then
test_that("test-LINCSLMMJuliaToDataFrameMapperGeneCol", {

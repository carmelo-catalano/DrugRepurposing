...
expected1 <- package_readRDS(paste0(test_config$LINCS_expected_dge_dir, "140_6h-expected.Rds"))
expected2 <- package_readRDS(paste0(test_config$LINCS_expected_dge_dir, "54812_6h-expected.Rds"))
...
result2 <- package_readRDS(paste0(test_config$LINCS_dge_output_dir, "54812_6h.Rds"))

...
rna_seq_data_filename <- absolute_path_filename("unit_test_data/voom/GSE153960_raw_counts_GRCh38.p13_NCBI_subset.tsv")
...
expected <- absolute_path_readRDS("unit_test_data/drug_repurpose/LMMDrugRepurposeByDreamWithEBayes_expected.Rds")

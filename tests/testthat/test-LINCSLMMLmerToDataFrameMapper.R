...
expected <- absolute_path_readRDS("unit_test_data/LMMDGE/LINCSLMMLmerToDataFrameMapperExpected.Rds")

# when
result <- sut$map(LMM_output, NA, "pert_iname", "drug", "pert_iname")

# then
test_that("test-LINCSLMMLmerToDataFrameMapper", {

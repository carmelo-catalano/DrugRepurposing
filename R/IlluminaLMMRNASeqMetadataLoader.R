IlluminaLMMRNASeqMetadataLoader <- R6Class(
  ...
  public = list(
    ...
    load = function(rna_seq_metadata_filename, tissue_status_field_name, tissue_statuses_to_be_tested, tissue_statuses_map, accession_field_name = "accession", additional_fields = FA) {
      ...
      rna_seq_metadata <- private$IlluminaLMMRNASeqMetadataMapper$map(rna_seq_metadata, tissue_status_field_name, tissue_statuses_to_be_tested, tissue_statuses_map, accession_field_name, additional_fields)

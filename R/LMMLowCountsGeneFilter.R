LMMLowCountsGeneFilter <- R6Class(
  ...
  public = list(
    ...
    filter = function(rna_data, rna_metadata, random_effect_column_name, sample_status_column_name) {
      rna_data <- private$lowCountsGeneFilter$filter(rna_data, rna_metadata[[sample_status_column_name]])
      return(private$

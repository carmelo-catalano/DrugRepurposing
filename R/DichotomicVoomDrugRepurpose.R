DichotomicVoomDrugRepurpose <- R6Class(
  ...
  public = list(
    ...
    compute = function(rna_seq, sample_01_map, drug_signatures, drugs_genes, random_distribution_size = 10^5,
      ...
      return(
        private$dichotomicDrugRepurposeCore$compute(
          rna_seq, sample_01_map, drug_signatures, drugs_genes, random_distribution_size, disease_name,
